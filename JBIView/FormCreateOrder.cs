...
namespace JBIView
{
    public partial class FormCreateOrder : Form
    {
        ...
        private readonly IJbiService serviceS;

        private readonly IMainService serviceM;

        public FormCreateOrder(IClientService serviceC, IJbiService serviceS, IMainService serviceM)
        {
            InitializeComponent();
        ...
        private void FormCreateOrder_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                List<JbiViewModel> listP = serviceS.GetList();
                if (listP != null)
                {
                    comboBoxProduct.DisplayMember = "JbiName";
        ...
        private void CalcSum()
        {
            if (comboBoxProduct.SelectedValue != null && !string.IsNullOrEmpty(textBoxCount.Text))
            {
                try
                {
                    ...
                    JbiViewModel product = serviceS.GetElement(id);                    
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                serviceM.CreateOrder(new OrderBindingModel
                {
                    ...
                    JbiId = Convert.ToInt32(comboBoxProduct.SelectedValue),
